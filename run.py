...
def get_sales_data():
    ...
    """
    while True:
        print("Please enter salaes data from the last market")
...
def validate_data(values):
    ...
    Raise ValueError if strings cannot be converted from str to int 
    or if there are less than 6 values.
    """
    try:
...
def calculate_surplus_data(sales_row):
    """
    Compare sales with stock and claculate the surplus for each item type
...
def update_worksheet(data, worksheet):
    """
    Receives a list of integers into a workshee
    update relevant the worksheet witht he data provided
    """
...
def get_stock_values(data):
    ...
    """
    # headings = SHEET.worksheet('stock').row_values(1) or index 0
